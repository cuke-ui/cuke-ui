...
describe("<Divider/>", () => {
  ...
  it("should find cuke-divider classnames", () => {
    ...
    assert(wrapper.find(".cuke-divider-horizontal-title").length === 1);
    assert(wrapper.find(".cuke-divider-horizontal-title-left").length === 1);
  ...
  it("should render center title divider", () => {
    ...
    assert(wrapper.find(".cuke-divider-horizontal-title").length === 1);
    assert(wrapper.find(".cuke-divider-horizontal-title-center").length === 1);
    assert(wrapper.find(".cuke-divider-title-text").length === 1);
  ...
  it("should render right title divider", () => {
    ...
    assert(wrapper.find(".cuke-divider-horizontal-title").length === 1);
    assert(wrapper.find(".cuke-divider-horizontal-title-right").length === 1);
    assert(wrapper.find(".cuke-divider-title-text").length === 1);
    assert(wrapper.find("b").length === 2);
    assert(wrapper.find("span").length === 1);
  });
