...
.add('Alert 警告提示', withInfo()(() => (
  <div style={{width:"50%"}}>
    ...
    <h2>描述</h2>
    <Alert type="success" message="一等奖" description="获得5元兰博基尼购车优惠券"/>
    <Alert type="info" message="通知" description="请李时珍的皮同学赶快回家,你妈在找你"/>
    <Alert type="error" message="错误" description="发生了未知的错误"/>
    <Alert type="warning" message="警告" description="不要在写代码了,快要猝死了"/>

    <h2>显示图标</h2>
    <Alert type="success" showIcon message="恭喜你获得5元兰博基尼购车优惠券"/>
    <Alert type="info" showIcon message="恭喜你获得5元兰博基尼购车优惠券"/>
    <Alert type="error" showIcon message="恭喜你获得5元兰博基尼购车优惠券"/>
    <Alert type="warning" showIcon message="大哥" description="求求你不要在秀了"/>

    <h2>可关闭的</h2>
    <Alert type="success" showIcon closable message="有本事关掉我?"/>

    <h2>自定义关闭文字</h2>
    <Alert type="error" showIcon closable closeText="忽略" message="有一个 bug?"/>

    <h2>关闭回调</h2>
    <Alert type="error" showIcon closable  message="有一个 bug?" onClose={()=> console.log('关闭了')}/>
  </div>
)))
