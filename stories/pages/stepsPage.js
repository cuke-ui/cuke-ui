...
export default class StepsPage extends PureComponent {
  ...
  onContentChange = (_, current) => {
    this.setState({
      contentCurrent: current - 1
    })
  }
  render() {
    return (
      <div className="example-steps-page">
        ...
        <Steps current={this.state.contentCurrent}>
          <Steps.Step title="第一步" description="打开冰箱111111">内容111111</Steps.Step>
          <Steps.Step title="第二步" description="放入大象22222">内容222222</Steps.Step>
          <Steps.Step title="第三步" description="关上冰箱33333">内容333333</Steps.Step>
        </Steps>
        ...
        <h2>自定义图标</h2>
        <Steps current={2}>
          <Steps.Step title="第一步" description="打开冰箱111111" icon={<WarningIcon />} />
          <Steps.Step title="第二步" description="放入大象22222" icon={<CloseIcon />} />
          <Steps.Step title="第三步" description="关上冰箱33333" icon={<ArrowRightIcon />} />
        </Steps>
